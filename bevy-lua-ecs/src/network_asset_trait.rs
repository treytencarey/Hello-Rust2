...
pub trait NetworkAssetRequestor: Send + Sync + 'static {
    ...
    fn register_pending_coroutine(&self, path: &str, coroutine_key: Arc<RegistryKey>, instance_id: u64);
...
impl NetworkAssetLoader {
    ...
    pub fn register_pending_coroutine(&self, path: &str, coroutine_key: Arc<RegistryKey>, instance_id: u64) {
        self.requestor.register_pending_coroutine(path, coroutine_key, instance_id);
    }
