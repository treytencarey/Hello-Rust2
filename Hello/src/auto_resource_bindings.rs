    ...
    match event_type {
        ...
        | "bevy::input::gamepad::GamepadAxisChangedEvent" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "GamepadAxisChangedEvent");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        | "bevy::input::gamepad::GamepadButtonChangedEvent" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "GamepadButtonChangedEvent");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        | "bevy::input::gamepad::GamepadButtonStateChangedEvent" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "GamepadButtonStateChangedEvent");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        | "bevy::input::gamepad::GamepadConnectionEvent" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "GamepadConnectionEvent");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        | "bevy::input::gamepad::GamepadEvent" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "GamepadEvent");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        | "bevy::input::gamepad::GamepadRumbleRequest" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "GamepadRumbleRequest");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        | "bevy::picking::pointer::PointerInput" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "PointerInput");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        | "bevy::input::gamepad::RawGamepadAxisChangedEvent" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "RawGamepadAxisChangedEvent");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        | "bevy::input::gamepad::RawGamepadButtonChangedEvent" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "RawGamepadButtonChangedEvent");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        | "bevy::input::gamepad::RawGamepadEvent" => {
            ...
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "RawGamepadEvent");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
        ...
        "TouchInput" | "bevy_input::touch::TouchInput" | "bevy::input::touch::TouchInput" => {
            let instance_id: u64 = lua.globals().get("__INSTANCE_ID__").unwrap_or(0);
            let accumulator = world
                .resource::<bevy_lua_ecs::LuaEventAccumulator>()
                .clone();
            let events = accumulator.drain(instance_id, "TouchInput");
            let results = lua.create_table()?;
            let mut index = 1;
            for event_json in events {
                if let Ok(lua_value) = bevy_lua_ecs::json_to_lua_value(lua, &event_json) {
...
fn register_bevy_events(app: &mut bevy::prelude::App) {
    ...
    app.add_event::<bevy::input::gamepad::GamepadAxisChangedEvent>();
    app.register_type::<bevy::input::gamepad::GamepadAxisChangedEvent>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
        "bevy::input::gamepad::GamepadButtonChangedEvent"
    );
    app.add_event::<bevy::input::gamepad::GamepadButtonChangedEvent>();
    app.register_type::<bevy::input::gamepad::GamepadButtonChangedEvent>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
        "bevy::input::gamepad::GamepadButtonStateChangedEvent"
    );
    app.add_event::<bevy::input::gamepad::GamepadButtonStateChangedEvent>();
    app.register_type::<bevy::input::gamepad::GamepadButtonStateChangedEvent>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
        "bevy::input::gamepad::GamepadConnectionEvent"
    );
    app.add_event::<bevy::input::gamepad::GamepadConnectionEvent>();
    app.register_type::<bevy::input::gamepad::GamepadConnectionEvent>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
        "bevy::input::gamepad::GamepadEvent"
    );
    app.add_event::<bevy::input::gamepad::GamepadEvent>();
    app.register_type::<bevy::input::gamepad::GamepadEvent>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
        "bevy::input::gamepad::GamepadRumbleRequest"
    );
    app.add_event::<bevy::input::gamepad::GamepadRumbleRequest>();
    app.register_type::<bevy::input::gamepad::GamepadRumbleRequest>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
        "bevy::input::keyboard::KeyboardFocusLost"
    );
    ...
    app.add_event::<bevy::input::gamepad::RawGamepadAxisChangedEvent>();
    app.register_type::<bevy::input::gamepad::RawGamepadAxisChangedEvent>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
        "bevy::input::gamepad::RawGamepadButtonChangedEvent"
    );
    app.add_event::<bevy::input::gamepad::RawGamepadButtonChangedEvent>();
    app.register_type::<bevy::input::gamepad::RawGamepadButtonChangedEvent>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
        "bevy::input::gamepad::RawGamepadEvent"
    );
    app.add_event::<bevy::input::gamepad::RawGamepadEvent>();
    app.register_type::<bevy::input::gamepad::RawGamepadEvent>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
    ...
    app.register_type::<bevy::input::touch::TouchInput>();
    bevy::log::debug!(
        "[REGISTER_EVENTS] Adding event type: {}",
        "bevy::window::WindowBackendScaleFactorChanged"
    );
    ...
    app.register_type::<bevy::input::ButtonInput<bevy::input::keyboard::Key>>();
    bevy::log::debug!(
        "[REGISTER_RESOURCES] Adding resource type: {}",
        "ButtonInput<Key>"
    );
...
fn accumulate_events_for_lua(world: &mut bevy::prelude::World) {
    ...
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::gamepad::GamepadAxisChangedEvent>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
    ...
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::gamepad::GamepadButtonChangedEvent>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
    ...
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::gamepad::GamepadButtonStateChangedEvent>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
    ...
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::gamepad::GamepadConnectionEvent>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
    ...
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::gamepad::GamepadEvent>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
            if let Some(event_json) = bevy_lua_ecs::reflect_to_json(event, &type_registry.read()) {
                accumulator.push_to_instances(&active_instances, "GamepadEvent", event_json);
            }
        }
    }
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::gamepad::GamepadRumbleRequest>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
    ...
    }
    {
        ...
        for event in event_reader.read() {
            if let Some(event_json) = bevy_lua_ecs::reflect_to_json(event, &type_registry.read()) {
                accumulator.push_to_instances(&active_instances, "PointerInput", event_json);
            }
        }
    }
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::gamepad::RawGamepadAxisChangedEvent>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
    ...
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::gamepad::RawGamepadButtonChangedEvent>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
    ...
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::gamepad::RawGamepadEvent>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
            if let Some(event_json) = bevy_lua_ecs::reflect_to_json(event, &type_registry.read()) {
                accumulator.push_to_instances(&active_instances, "RawGamepadEvent", event_json);
            }
        }
    }
    {
    ...
    {
        let mut system_state = bevy::ecs::system::SystemState::<(
            bevy::prelude::EventReader<bevy::input::touch::TouchInput>,
            bevy::prelude::Res<bevy::prelude::AppTypeRegistry>,
        )>::new(world);
        let (mut event_reader, type_registry) = system_state.get_mut(world);
        for event in event_reader.read() {
            if let Some(event_json) = bevy_lua_ecs::reflect_to_json(event, &type_registry.read()) {
                accumulator.push_to_instances(&active_instances, "TouchInput", event_json);
            }
        }
    }
    {
