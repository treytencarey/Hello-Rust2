...
function Client.send_system(world)
    ...
    for _, msg_entity in ipairs(outbound) do
        ...
        -- print(string.format("[NET_CLIENT] Sending message (%s): %s", channel == Messages.CHANNEL_RELIABLE and "RELIABLE" or "UNRELIABLE", encoded))
...
function Client.receive_system(world)
    ...
    while true do
        ...
        -- print(string.format("[NET_CLIENT] Received message: %s", msg_data))
