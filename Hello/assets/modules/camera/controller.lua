...
local ThirdPerson = require("modules/camera/third_person.lua")
...
function CameraController.ensure_camera(world)
    ...
    print(string.format("[CAMERA] Created camera entity %d", camera_id))
...
function CameraController.attach(world, target_entity_id)
    ...
    print(string.format("[CAMERA] Attached to target entity %d (yaw=%.2f)", target_entity_id, state.yaw))
end
...
function CameraController.detach()
    ...
    print("[CAMERA] Detached from target")
end
...
print("[CAMERA] System registered")
